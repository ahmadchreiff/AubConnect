          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
                {/* Center everything before the Course Description */}
                <div className="flex flex-col items-center text-center mb-6">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-white border border-[#860033] text-[#860033]"
                    >
                  ...
                  <div className="mt-4 flex flex-col items-center">
                    <div className="text-4xl font-bold text-[#860033]">{averageRating}<span className="ml-1 text-yellow-400">★</span></div>
