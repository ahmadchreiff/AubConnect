    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          ...
          {/* Filter tabs */}
          {reviews.length > 0 && (
            <div className="border-b border-gray-200 p-6 flex flex-wrap gap-2">
              <button
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg ${filter === 'courses' 
                  ? 'bg-[#6D0B24] text-white' 
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg ${filter === 'professors' 
                  ? 'bg-[#6D0B24] text-white' 
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
              >
          ...
          {reviews.length === 0 ? (
            ...
            <div className="flex flex-col">
              {filteredReviews().map((review) => (
                <div key={review._id} className="px-6 py-6 border-b border-gray-200 w-full">
                  <div className="flex flex-col w-full">
                      ...
                      <div className="flex flex-wrap items-center">
                        {review.type === 'course' ? (
                          <Link
                            ...
                            className="text-lg font-medium text-[#6D0B24] hover:underline mr-2"
                          >
                    ...
                    {review.status === 'rejected' && (
                      <div className="my-3 p-3 bg-red-50 border-l-4 border-red-400 text-sm text-red-700 rounded">
                    ...
                    <div className="mt-3 text-gray-700 break-words">
